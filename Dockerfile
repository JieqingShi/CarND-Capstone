...
# Adding proxy to resolve error
#ENV http_proxy "http://q454024:guccibugattipoincarepug@proxy.muc:8081"
#ENV https_proxy "http://q454024:guccibugattipoincarepug@proxy.muc:8080"
